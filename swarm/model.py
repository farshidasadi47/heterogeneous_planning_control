...
class SwarmSpecs:
    ...
    def _set_letters(self):
        ...
        #
        chars4= dict()
        chars4['*']= {'poses': [-45,  0, -15,  0,  15,  0,  45,  0],
                      'shape': [0,1, 1,2, 2,3, 999,999],
                      'steps': 3}
        chars4['1']= {'poses': [  0, 60,   0, 20,   0,-20,   0,-60],
                      'shape': [0,1, 1,2, 2,3, 999,999],
                      'steps': 3}
        chars4['7']= {'poses': [-40, 40, -40,-40,   0,  0,  40, 40],
                      'shape': [0,3, 1,2, 2,3, 999,999],
                      'steps': 3}
        chars4['D']= {'poses': [-40, 40, -40,-40,  40, 20,  40,-20],
                      'shape': [0,1, 0,2, 1,3, 2,3],
                      'steps': 3}
        chars4['I']= {'poses': [  0, 60,   0, 20,   0,-20,   0,-60],
                      'shape': [0,1, 1,2, 2,3, 999,999],
                      'steps': 3}
        chars4['J']= {'poses': [-40,-20,   0,-40,  40,-20,  40, 40],
                      'shape': [0,1, 1,2, 2,3, 999,999],
                      'steps': 3}
        chars4['L']= {'poses': [-40, 40, -40,  0, -40,-40,  30,-40],
                      'shape': [0,1, 1,2, 2,3, 999,999],
                      'steps': 3}
        chars4['N']= {'poses': [-40, 40, -40,-40,  40, 40,  40,-40],
                      'shape': [0,1, 0,3, 2,3, 999,999],
                      'steps': 3}
        chars4['T']= {'poses': [-40, 40,   0, 40,   0,-40,  40, 40],
                      'shape': [0,1, 1,2, 1,3, 999,999],
                      'steps': 3}
        chars4['V']= {'poses': [-40, 40, -20,  0,   0,-40,  40, 40],
                      'shape': [0,1, 1,2, 2,3, 999,999],
                      'steps': 3}
        chars4['Y']= {'poses': [  0,  0,   0,-50,  30, 40, -30, 40],
                      'shape': [0,1, 0,2, 0,3, 999,999],
                      'steps': 3}
        chars4['Z']= {'poses': [-30, 40, -40,-40,  40, 40,  40,-40],
    ...
    @classmethod
    def robo4p(cls):
        pivot_length = np.array([[7.43,4.73,4.87,4.79],
                                 [4.74,4.77,4.87,7.27],
                                 [4.81,4.77,7.28,4.84],
                                 [4.80,7.33,4.84,4.80]])
        pivot_length = np.array([[7.43,4.61,4.98,4.91],
                                 [4.74,4.65,4.69,7.28],
                                 [4.81,4.78,7.23,4.93],
                                 [4.80,8.02,4.86,5.12]])
